...
import resume from '../Compo/TechResume.pdf'
    ...
    return (
        ...
        id="summary_div">
            ...
            <div id="summary_left_div">
                ...
                <button id="Download_resume_btn"><a id="Download_resume_btn_a_tag" download="resume" href={resume}>Download Resume <FaDownload/></a></button>
            </div>
